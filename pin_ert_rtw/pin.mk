###########################################################################
## Makefile generated for component 'pin'. 
## 
## Makefile     : pin.mk
## Generated on : Wed Nov 16 12:40:29 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/pin.elf
...
START_DIR                 = $(MATLAB_WORKSPACE)/C/Users/richa/OneDrive/Desktop/fyp/SIMULINK
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/pin.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/realtime/targets/linux/include -I$(START_DIR)/pin_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/realtime/targets/raspi/include -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_STANDARD = -DMODEL=pin -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = pin.c.o pin_data.c.o MW_raspi_init.c.o MW_Pyserver_control.c.o linuxinitialize.c.o
...
%.c.o : $(START_DIR)/pin_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/pin_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/pin_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/pin_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


pin.c.o : $(START_DIR)/pin_ert_rtw/pin.c
	$(CC) $(CFLAGS) -o "$@" "$<"


pin_data.c.o : $(START_DIR)/pin_ert_rtw/pin_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
